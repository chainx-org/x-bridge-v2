    ...
    return (
        <BridgeStyle>
            ...
            <TransactionBubbleStyle>
                <ul>
                    <li onClick={() => SetIssueModalVisible(true)}><IssueBubble/></li>
                    <li onClick={() => SetRedeemModalVisible(true)}><RedeemBubble/></li>
                </ul>
            </TransactionBubbleStyle>

            <IssueModalStyle>
                <Modal visible={issueModalVisible} onCancel={() => SetIssueModalVisible(false)} footer={null}
                       getContainer={false}
                       title={"请尽快完成转账"}>
                    <IssueModalTip>
                    ...
                    <VaultOpReturnStyle>
                        ...
                        <div className={"address"}>81e71f40d31aa46f09da3f5d58a879c54708725f96730df2d8ac67050b6e2a07</div>
                    </VaultOpReturnStyle>
                    <IssueModalFooter>
                        <ul>
                            <li>
            ...
            <RedeemModalStyle>
                <Modal visible={RedeemModalVisible} onCancel={() => SetRedeemModalVisible(false)} footer={null}
                       getContainer={false}
                       title={t('Redeem')}>
                    <RedeemModalTip>
                        <img src={warningLogo} alt=""/>
                        <div>{t('If you do not receive the redeemed BTC within 48 hours, you can make a redemption request again after the cancellation of redemption or forced redemption. If you choose forced redemption, you will receive the equivalent PCX immediately')}</div>
                    </RedeemModalTip>
                    <RedeemTimeStyle>
                        <div className={"title"}>
                            {t('Remaining time')}
